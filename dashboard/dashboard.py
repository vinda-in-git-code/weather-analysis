...
with st.expander("💡 Lihat Insight Pertanyaan 1"):
    st.write("Kualitas udara terburuk terjadi pada dini hari (sekitar pukul 01.00–02.00) akibat akumulasi polutan, sementara kondisi terbaik terjadi pada sore hari (sekitar pukul 15.00–17.00) yang menunjukkan proses dispersi polutan lebih optimal pada waktu tersebut.")
...
with st.expander("💡 Lihat Insight Pertanyaan 2"):
    st.write("Tren bulanan PM2.5 menunjukkan variasi musiman yang jelas, dengan konsentrasi tertinggi pada musim dingin dan terendah pada musim panas, serta adanya puncak polusi ekstrem di bulan-bulan tertentu tanpa tren jangka panjang yang konsisten, yang menandakan masalah kualitas udara yang masih berkelanjutan di Nongzhanguan.")
...
if not df_winter.empty:
    ...
    with st.expander("💡 Lihat Insight Pertanyaan 3"):
        st.write("Pada musim dingin, titik embun (DEWP) memiliki korelasi positif sangat kuat dengan PM2.5, menunjukkan bahwa kelembapan tinggi cenderung memerangkap polutan, sementara kecepatan angin (WSPM) berkorelasi negatif kuat yang menandakan angin membantu menyebarkan polutan; tekanan udara (PRES) berpengaruh negatif moderat, sedangkan suhu (TEMP) dan curah hujan (RAIN) memiliki pengaruh yang sangat lemah terhadap konsentrasi PM2.5.")
else:
...
with st.expander("💡 Lihat Insight Pertanyaan 4"):
    st.write("Kualitas udara di Nongzhanguan bervariasi signifikan antar musim, dengan konsentrasi PM2.5 tertinggi pada musim dingin (104,87 µg/m³) diikuti musim gugur (90,18 µg/m³), kemudian musim semi (79,25 µg/m³), dan terendah pada musim panas (66,45 µg/m³), yang kemungkinan dipengaruhi oleh perbedaan kondisi cuaca seperti suhu, angin, dan curah hujan serta variasi aktivitas manusia di tiap musim.")

# 11. Final Conclusion
st.markdown("---")
st.subheader("📌 Kesimpulan Akhir")
st.success("Hasil Exploratory Data Analysis (EDA) menunjukkan bahwa konsentrasi PM2.5 di Kota Nongzhanguan memiliki pola harian yang jelas, dengan nilai tertinggi pada jam tertentu akibat aktivitas manusia seperti lalu lintas dan industri. Secara temporal, tren bulanan berfluktuasi signifikan, dipengaruhi oleh kondisi cuaca—terutama di musim dingin—seperti suhu, tekanan, kelembapan, curah hujan, dan kecepatan angin yang dapat menghambat dispersi polutan. Secara musiman, kualitas udara terburuk terjadi pada musim dingin, menegaskan bahwa tingkat PM2.5 dipengaruhi oleh kombinasi waktu, faktor meteorologi, dan musim, sehingga pengendalian polusi perlu difokuskan pada periode berisiko tinggi.")
